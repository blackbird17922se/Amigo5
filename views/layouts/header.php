                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="header-top-wraper">
                            <!-- ROW QUE CONTIE LA BARRA DEL MENU PRINCIP -->
                            <!-- Barra de modulos -->
                            <div class="row bsuperior" id="modulBar">
                                ...
                                <div id="conMenu" class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                    <div class="header-top-menu tabl-d-n">
                                        <ul class="nav navbar-nav mai-top-nav">                                  
                                            <li class="nav-item"><a href="usuario.php" class="nav-link modul-item">Usuarios</a>
                                            </li>
                                            <li class="nav-item"><a href="mecanico.php" class="nav-link modul-item">Mecanicos</a>
                                            </li>
                                            <li class="nav-item"><a href="ord_veh.php" class="nav-link modul-item">Órdenes y vehículos</a>
                                            </li>
